...
void Merge(int a[], long int p, long int q, long int r)   // 把arr中的 [begin, mid]、 [mid+1, end] 两个有序片段排成一个有序序列
{
...
void MergeSort(int a[], long int p, long int r)   //对[left, right]进行排序
{
